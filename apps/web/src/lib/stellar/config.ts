...
export const STELLAR_ASSETS = {
  ...
  EURC: new Asset(
    "EURC",
    IS_TESTNET
      ? "GBBD47IF6LWK7P7MDEVSCWR7DPUWV3NY3DTQEVFL4NAT4AQH3ZLLFLA5" // testnet EURC issuer (placeholder)
      : "GA5ZSEJYB37JRC5AVCIA5MOP4RHTM335X2KGX3IHOJAPP5RE34K4KZVN"  // mainnet EURC (placeholder)
  ),
  XLM: Asset.native(),
} as const;
